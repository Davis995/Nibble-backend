...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="usage_logs_student_8f203e_idx",
                    ),
                    models.Index(
                        fields=["school", "created_at"],
                        name="usage_logs_school__ff1ac2_idx",
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="staff",
            index=models.Index(
                fields=["school", "school_email"], name="staff_school__3b1502_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="staff",
        ...
        migrations.AddConstraint(
            model_name="staff",
            constraint=models.UniqueConstraint(
                fields=("school", "school_email"), name="unique_staff_email_per_school"
            ),
        ),
    ]
