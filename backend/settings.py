"""
Django settings for Nibble AI project.
"""
...
# SSO Token Lifetime (24 hours for school-based SSO)
...
SIMPLE_JWT = {
    ...
    'TOKEN_VALIDATION_BLACKLIST': 'rest_framework_simplejwt.token_blacklist.models.BlacklistedToken',
}
...
OUTPUT_TOKEN_PRICE = config('OUTPUT_TOKEN_PRICE', default=0.60, cast=float)
...
PESAPAL_NOTIFICATION_ID = config('PESAPAL_NOTIFICATION_ID', default='fe078e53-78da-4a83-aa89-e7ded5c456e6')
PESAPAL_BASE_URL = config('PESAPAL_BASE_URL', default='https://pay.pesapal.com/v3/api')
PESAPAL_CALLBACK_URL = config('PESAPAL_CALLBACK_URL', default='https://yourdomain.com/api/payments/callback/')
PESAPAL_IPN_URL = config('PESAPAL_IPN_URL', default='https://yourdomain.com/api/payments/ipn/')
